...
namespace VampariaSurvivors.Content.Projectile
{
    public class BoneControllerProjectile : ModProjectile
    {
        ...
        {
            // Check if any Bone weapon is in the player's inventory
            for (int i = 0; i < player.inventory.Length; i++)
            {
                if (player.inventory[i].ModItem is VSWeapon weapon && weapon.WeaponIdentifier == "Bone")
                {
                    return true;
                }
            }
        ...
        public override void AI()
        {
            ...
            // Check if the Bone weapon is still equipped/in inventory
