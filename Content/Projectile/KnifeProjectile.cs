...
namespace VampariaSurvivors.Content.Projectile
{
    public class KnifeControllerProjectile : ModProjectile
    {
        ...
        {
            // Check if any Knife weapon is in the player's inventory
            for (int i = 0; i < player.inventory.Length; i++)
            {
                if (player.inventory[i].ModItem is VSWeapon weapon && weapon.WeaponIdentifier == "Knife")
                {
                    return true;
                }
            }
        ...
        public override void AI()
        {
            ...
            // Check if the Knife weapon is still equipped/in inventory
