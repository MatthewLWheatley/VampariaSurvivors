...
namespace VampariaSurvivors.Content.Projectile
{
    public class WhipControllerProjectile : ModProjectile
    {
        ...
        {
            // Check if any Whip weapon is in the player's inventory
            for (int i = 0; i < player.inventory.Length; i++)
            {
                if (player.inventory[i].ModItem is VSWeapon weapon && weapon.WeaponIdentifier == "Whip")
                {
                    return true;
                }
            }
        ...
        public override void AI()
        {
            ...
            // Check if the Whip weapon is still equipped/in inventory
