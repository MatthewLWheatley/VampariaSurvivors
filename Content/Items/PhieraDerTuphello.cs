...
{
    public class PhieraDerTuphelloLvl1 : VSWeapon
    {
        public override string Texture => "VampariaSurvivors/Content/Items/PhieraDerTuphello";
        public override string WeaponName => "Phiera Der Tuphello";
        public override string WeaponDescription => GetLevelDescription();
        public override int ControllerProjectileType => ModContent.ProjectileType<PhieraDerTuphelloControllerProjectile>();
        public override string WeaponIdentifier => "PhieraDerTuphello";
        ...
        private string GetLevelDescription()
        {
            return Level switch
            {
                1 => "Fires quickly in four fixed directions.",
                ...
                _ => "Fires quickly in four fixed directions."
            };
        }
        ...
        protected override int GetWeaponTypeAtLevel(int level)
        {
            return level switch
            {
                1 => ModContent.ItemType<PhieraDerTuphelloLvl1>(),
                2 => ModContent.ItemType<PhieraDerTuphelloLvl2>(),
                3 => ModContent.ItemType<PhieraDerTuphelloLvl3>(),
                4 => ModContent.ItemType<PhieraDerTuphelloLvl4>(),
                5 => ModContent.ItemType<PhieraDerTuphelloLvl5>(),
                6 => ModContent.ItemType<PhieraDerTuphelloLvl6>(),
                7 => ModContent.ItemType<PhieraDerTuphelloLvl7>(),
                8 => ModContent.ItemType<PhieraDerTuphelloLvl8>(),
                _ => level > 8 ? ModContent.ItemType<PhieraDerTuphelloLvl8>() : -1
            };
        }
    }

    public class PhieraDerTuphelloLvl2 : PhieraDerTuphelloLvl1
    {
        public override int Level { get; set; } = 2;
    }

    public class PhieraDerTuphelloLvl3 : PhieraDerTuphelloLvl1
    {
        public override int Level { get; set; } = 3;
    }

    public class PhieraDerTuphelloLvl4 : PhieraDerTuphelloLvl1
    {
        public override int Level { get; set; } = 4;
    }

    public class PhieraDerTuphelloLvl5 : PhieraDerTuphelloLvl1
    {
        public override int Level { get; set; } = 5;
    }

    public class PhieraDerTuphelloLvl6 : PhieraDerTuphelloLvl1
    {
        public override int Level { get; set; } = 6;
    }

    public class PhieraDerTuphelloLvl7 : PhieraDerTuphelloLvl1
    {
        public override int Level { get; set; } = 7;
    }

    public class PhieraDerTuphelloLvl8 : PhieraDerTuphelloLvl1
    {
